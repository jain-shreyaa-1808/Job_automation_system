...
export class JobLinkValidatorService {
    ...
    static CLOSED_POSTING_PATTERNS = [
    ...
    async validateUrl(url) {
        try {
            ...
            const isGeneric = JobLinkValidatorService.GENERIC_PAGE_PATTERNS.some((pattern) => pattern.test(finalUrl));
            if (isGeneric) {
                return {
                    valid: false,
                    reason: "Redirects to a generic careers/search page, not a specific opening",
                };
            }
     ...
     */
    async validateJobsForUser(userId) {
...
//# sourceMappingURL=job-link-validator.service.js.map