...
export class MockJobProvider {
    sourceMode = "mock";
    async fetchJobs({ preferredRoles, }) {
        const preferredKeywords = preferredRoles.flatMap((role) => role
            .toLowerCase()
            .split(/\s+/)
        ...
        }).map((job) => ({ ...job, sourceMode: this.sourceMode }));
    }
}
//# sourceMappingURL=mock-job-provider.js.map